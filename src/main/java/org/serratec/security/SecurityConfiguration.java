...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
        	...
        	.antMatchers(HttpMethod.GET, "/usuario/detalhe/{id}").permitAll()
        	.antMatchers(HttpMethod.PUT, "/usuario/{id}").permitAll()
        	.antMatchers(HttpMethod.GET, "/usuario/desativar/{email}").permitAll()
        	.antMatchers(HttpMethod.GET, "/usuario/reativar/{email}").permitAll()
        	.antMatchers(HttpMethod.POST, "/usuario/email-senha").permitAll()
        	.antMatchers(HttpMethod.POST, "/usuario/alterar-senha").permitAll()
